  ...
  return (
    <label className="inline-flex items-center relative h-[34px] cursor-pointer">
      <input
        ...
        type="checkbox"
      />
      <div className="relative w-[60px] border h-[28px] bg-card rounded-full after:absolute after:content-[''] after:w-[20px] after:top-[3px] after:h-[20px] after:bg-gradient-to-r from-orange-500 to-yellow-400 peer-checked:after:from-zinc-700/70 peer-checked:after:to-zinc-700/70 after:rounded-full after:left-[3px] active:after:w-[50px] peer-checked:after:left-[34px] duration-300 after:duration-300 after:shadow-md" />
      <svg
        height={0}
        width={100}
        viewBox="0 0 24 24"
      ...
      <svg
        ...
        id="Layer_1"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-6 h-[14px] right-[2px]"
      >
